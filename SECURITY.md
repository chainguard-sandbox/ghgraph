...
Please report vulnerabilities via email to [mark.esler@chainguard.dev](mailto:mark.esler@chainguard.dev).
...
ghgraph's trust model — what it trusts, what it treats as hostile, and the
residual risk accepted by design — is described in
[DESIGN.md's Security posture](DESIGN.md#security-posture). Vulnerabilities
in the `gh` CLI, ghgraph's transport, belong upstream at
